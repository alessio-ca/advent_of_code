...
You can hear birds chirping and raindrops hitting leaves as the expedition proceeds.
 Occasionally, you can even hear much louder sounds in the distance; how big do th
...
# good candidates for deletion. To do this, you need to determine the total size of
#  each directory. The total size of a directory is the sum of the sizes of the files
#  it contains, directly or indirectly. (Directories themselves do not count as having
#  any intrinsic size.)
...
To begin, find all of the directories with a total size of at most 100000, then
 calculate the sum of their total sizes. In the example above, these directories are a
  and e; the sum of their total sizes is 95437 (94853 + 584). (As in this example, this
